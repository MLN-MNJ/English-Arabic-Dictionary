...
public class HomeActivity extends AppCompatActivity {
    // Declare TextViews for each category
    TextView textViewColors, textViewPhrases, textViewFamily, textViewNumbers;

    // Define a constant key to pass data between activities
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create data sources for categories
        // 1. Colors
        ...
        familyMembers.add(new Dictionary(R.drawable.family_father, R.string.family_father_english,
                R.string.family_father_arabic, R.color.family_members_background));
        ...
        // Set up explicit intents for each category
        ...
        translateButton.setOnClickListener(v -> {
            ...
            intent.putExtra("ENGLISH_WORD", "Hello"); // Example data
            intent.putExtra("ARABIC_WORD", "مرحبا");   // Example data
            startActivity(intent);
        });
    }

    // Explicit intent method for handling item click events
    public void explicitIntent(TextView view, ArrayList<Dictionary> datasource) {
        view.setOnClickListener(v -> {
            ...
            Log.d("TEST", "Intent started for category");
            startActivity(intent);
        });
    }
}
